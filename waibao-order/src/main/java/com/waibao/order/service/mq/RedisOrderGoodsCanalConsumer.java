...
public class RedisOrderGoodsCanalConsumer implements MessageListenerConcurrently {
    ...
    public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs, ConsumeConcurrentlyContext context) {
        ...
        asyncService.basicTask(() -> orderGoodsCacheService.canalSync(redisCommandList));
