...
import com.waibao.order.service.cache.LogOrderRetailerCacheService;
...
/**
 * RedisLogOrderRetailerCanalConsumer
 *
...
public class RedisLogOrderRetailerCanalConsumer implements MessageListenerConcurrently {
    private final AsyncService asyncService;
    private final LogOrderRetailerCacheService logOrderRetailerCacheService;
    ...
    public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs, ConsumeConcurrentlyContext context) {
        ...
        asyncService.basicTask(() -> logOrderRetailerCacheService.canalSync(redisCommandList));
                ...
                .forEach(v -> {
                    ...
                    switch (jsonObject.getString("type")) {
                        ...
                        case "UPDATE":
                            ...
                            redisCommand.setOldValue(jsonObject.getJSONObject("old").toJavaObject(LogOrderRetailer.class));
                            break;
                        case "DELETE":
                    ...
                    redisCommand.setValue(((JSONObject) v).toJavaObject(LogOrderRetailer.class));
