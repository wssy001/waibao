...
VALUES (1, 'application.yml', 'DEFAULT_GROUP',
        'spring:\n  redis:\n    host: 10.61.20.211\n    password: wssy001\n    timeout: 1000\n    lettuce:\n      pool:\n        min-idle: 5\n        max-idle: 10\n\nwaibao:\n  db:\n    ip: 10.61.20.211\n    port: 33306\n    username: root\n    password: wssy001\n\n  rocketmq:\n    ip: 10.61.20.211\n    port: 39876',
        '27b8dcde87fb5664436b9fcb4e232b08', '2022-03-30 12:12:34', '2022-04-02 04:55:30', 'nacos', '172.17.0.1', '',
        'waibao', '', '', '', 'yaml', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`,
                           `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`)
VALUES (2, 'waibao-user.yml', 'DEFAULT_GROUP',
        ...
        'a4d2a6dbed95c4bb0cd3e0a286e9da51', '2022-03-30 12:12:34', '2022-04-02 08:20:57', 'nacos', '172.17.0.1', '',
        'waibao', '', '', '', 'yaml', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`,
                           `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`)
VALUES (3, 'waibao-gateway.yml', 'DEFAULT_GROUP',
        ...
        '48153c0d00ae9020f0c6569addf55121', '2022-03-30 12:12:34', '2022-04-01 05:27:22', 'nacos', '172.17.0.1', '',
        'waibao', '', '', '', 'yaml', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`,
                           `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`)
VALUES (4, 'waibao-rcde.yml', 'DEFAULT_GROUP',
        ...
        'd1d9bd521a27a47054f05ffaee0978b5', '2022-03-30 12:12:34', '2022-03-30 13:00:26', 'nacos', '172.17.0.1', '',
        'waibao', '', '', '', 'yaml', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`,
                           `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`)
...
VALUES (7, 'waibao-seckill.yml', 'DEFAULT_GROUP',
        ...
        'a73c8d066640ce753a5ebf4221ae58a3', '2022-03-30 12:12:34', '2022-04-02 09:41:02', 'nacos', '172.17.0.1', '',
        'waibao', '', '', '', 'yaml', '');
COMMIT;
...
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (4, 8, 'waibao-rcde.yml', 'DEFAULT_GROUP', '',
        'spring:\n  datasource:\n    url: jdbc:mysql://10.61.20.211:33306/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n    username: root\n    password: wssy001\n    hikari:\n      max-lifetime: 28770000\n      maximum-pool-size: 20\n      minimum-idle: 5\n      connection-timeout: 28770000\n\n  task:\n    execution:\n      pool:\n        max-size: 4\n        keep-alive: 60s\n        core-size: 2\n        queue-capacity: 2000\n      thread-name-prefix: 异步任务-\n    scheduling:\n      pool:\n        size: 4\n      thread-name-prefix: 定时任务-',
        '6c8603c255b93641ad2540a77b428654', '2022-03-30 12:30:21', '2022-03-30 12:30:21', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (4, 9, 'waibao-rcde.yml', 'DEFAULT_GROUP', '',
        'spring:\n  datasource:\n    url: jdbc:mysql://10.61.20.211:33306/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n    username: root\n    password: wssy001\n    hikari:\n      max-lifetime: 28770000\n      maximum-pool-size: 20\n      minimum-idle: 5\n      connection-timeout: 28770000\n\n  task:\n    execution:\n      pool:\n        max-size: 4\n        keep-alive: 60s\n        core-size: 2\n        queue-capacity: 2000\n      thread-name-prefix: 异步任务-\n    scheduling:\n      pool:\n        size: 4\n      thread-name-prefix: 定时任务-\n\nrocketmq:\n  name-server: 10.61.20.211:39876\n  producer:\n    group: rcde-producer',
        'd1d9bd521a27a47054f05ffaee0978b5', '2022-03-30 12:47:48', '2022-03-30 12:47:48', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (4, 10, 'waibao-rcde.yml', 'DEFAULT_GROUP', '',
        'spring:\n  datasource:\n    url: jdbc:mysql://10.61.20.211:33306/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n    username: root\n    password: wssy001\n    hikari:\n      max-lifetime: 28770000\n      maximum-pool-size: 20\n      minimum-idle: 5\n      connection-timeout: 28770000\n\n  task:\n    execution:\n      pool:\n        max-size: 4\n        keep-alive: 60s\n        core-size: 2\n        queue-capacity: 2000\n      thread-name-prefix: 异步任务-\n    scheduling:\n      pool:\n        size: 4\n      thread-name-prefix: 定时任务-\n',
        '5b16c0ff70fdb0040dad002fd599417d', '2022-03-30 13:00:26', '2022-03-30 13:00:26', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (2, 11, 'waibao-user.yml', 'DEFAULT_GROUP', '',
        'spring:\n    shardingsphere:\n        datasource:\n        names: master,slave\n        master:\n            type: com.zaxxer.hikari.HikariDataSource\n            driverClassName: com.mysql.cj.jdbc.Driver\n            jdbcUrl: jdbc:mysql://10.61.20.211:33306/waibao_v2?useSSL=false&autoReconnect=true&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true\n            username: root\n            password: wssy001\n        slave:\n            type: com.zaxxer.hikari.HikariDataSource\n            driverClassName: com.mysql.cj.jdbc.Driver\n            jdbcUrl: jdbc:mysql://10.61.20.211:33307/waibao_v2?useSSL=false&autoReconnect=true&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true\n            username: root\n            password: wssy001\n\n        sharding:\n        tables:\n            user:\n            actualDataNodes: master.user_$->{0..1}\n            tableStrategy:\n                inline:\n                shardingColumn: id\n                algorithmExpression: user_$->{id % 2}\n            keyGenerator:\n                column: id\n                type: SNOWFLAKE\n\n        master-slave-rules:\n            master:\n            master-data-source-name: master\n            SlaveDataSourceNames: slave\nlogging:\n  level:\n    root: info',
        'c76cd3f0eece1b3f9e6f2e060b8d9a14', '2022-04-01 03:40:27', '2022-04-01 03:40:28', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (2, 12, 'waibao-user.yml', 'DEFAULT_GROUP', '',
        ...
        '3b9e4cabfac8af2ed3596150f119b90b', '2022-04-01 03:45:06', '2022-04-01 03:45:07', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (2, 13, 'waibao-user.yml', 'DEFAULT_GROUP', '',
        'spring:\n    shardingsphere:\n        datasource:\n            names: master,slave\n            master:\n                type: com.zaxxer.hikari.HikariDataSource\n                driverClassName: com.mysql.cj.jdbc.Driver\n                jdbcUrl: jdbc:mysql://10.61.20.211:33306/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n                username: root\n                password: wssy001\n            slave:\n                type: com.zaxxer.hikari.HikariDataSource\n                driverClassName: com.mysql.cj.jdbc.Driver\n                jdbcUrl: jdbc:mysql://10.61.20.211:33307/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n                username: root\n                password: wssy001\n\n        sharding:\n            tables:\n                user:\n                actualDataNodes: master.user_$->{0..1}\n                tableStrategy:\n                inline:\n                shardingColumn: id\n                algorithmExpression: user_$->{id % 2}\n                keyGenerator:\n                column: id\n                type: SNOWFLAKE\n    \n            master-slave-rules:\n                master:\n                master-data-source-name: master\n                SlaveDataSourceNames: slave',
        'a8be4a1a5e5d849f63a3985f8aead3b8', '2022-04-01 03:46:21', '2022-04-01 03:46:21', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (2, 14, 'waibao-user.yml', 'DEFAULT_GROUP', '',
        'spring:\n  application:\n    name: waibao-user\n\n  shardingsphere:\n    datasource:\n      names: master,slave\n      master:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://10.61.20.211:33306/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: root\n        password: wssy001\n      slave:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://10.61.20.211:33307/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: root\n        password: wssy001\n\n    sharding:\n      tables:\n        user:\n        actualDataNodes: master.user_$->{0..1}\n        tableStrategy:\n          inline:\n          shardingColumn: id\n          algorithmExpression: user_$->{id % 2}\n        keyGenerator:\n          column: id\n          type: SNOWFLAKE\n  \n      master-slave-rules:\n        master:\n        master-data-source-name: master\n        SlaveDataSourceNames: slave',
        '8b3d80b0e617840bada421523710bd1a', '2022-04-01 03:47:14', '2022-04-01 03:47:15', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (2, 15, 'waibao-user.yml', 'DEFAULT_GROUP', '',
        'spring:\n  shardingsphere:\n    datasource:\n      names: master,slave\n      master:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://10.61.20.211:33306/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: root\n        password: wssy001\n      slave:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://10.61.20.211:33307/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: root\n        password: wssy001\n\n    sharding:\n      tables:\n        user:\n        actualDataNodes: master.user_$->{0..1}\n        tableStrategy:\n          inline:\n          shardingColumn: id\n          algorithmExpression: user_$->{id % 2}\n        keyGenerator:\n          column: id\n          type: SNOWFLAKE\n  \n      master-slave-rules:\n        master:\n        master-data-source-name: master\n        SlaveDataSourceNames: slave',
        '857457a683c0ecbbbd52dbd684ae3a0b', '2022-04-01 03:51:42', '2022-04-01 03:51:42', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (3, 16, 'waibao-gateway.yml', 'DEFAULT_GROUP', '',
        'spring:\n  cloud:\n    gateway:\n      discovery:\n        locator:\n          enabled: true\n      routes:\n        - id: waibao-user #payment_routh    #路由的ID，没有固定规则但要求唯一，简易配合服务名\n          #          uri: http://localhost:8001         #匹配后提供服务的路由地址\n          uri: lb://waibao-user   #匹配后提供服务的路由地址，lb后跟提供服务的微服务的名，不要写错\n          predicates:\n            - Path=/**          #断言，路径相匹配的进行路由\n      globalcors:\n        cors-configurations:\n          \'[/**]\': # 匹配所有请求\n            allowedOrigins: \"*\" #跨域处理 允许所有的域\n            allowedMethods: # 支持的方法\n              - GET\n              - POST\n              - PUT\n              - DELETE\n\n  main:\n    web-application-type: reactive',
        'e3a89b8930adbc35cdfc9ef47a8c0ebf', '2022-04-01 04:29:25', '2022-04-01 04:29:26', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (3, 17, 'waibao-gateway.yml', 'DEFAULT_GROUP', '',
        'spring:\n  cloud:\n    gateway:\n      discovery:\n        locator:\n          enabled: true\n      routes:\n        - id: waibao-user #payment_routh    #路由的ID，没有固定规则但要求唯一，简易配合服务名\n          #          uri: http://localhost:8001         #匹配后提供服务的路由地址\n          uri: lb://waibao-user   #匹配后提供服务的路由地址，lb后跟提供服务的微服务的名，不要写错\n          filters:\n          - VerifyAndAddUserId\n          predicates:\n            - Path=/**          #断言，路径相匹配的进行路由\n      globalcors:\n        cors-configurations:\n          \'[/**]\': # 匹配所有请求\n            allowedOrigins: \"*\" #跨域处理 允许所有的域\n            allowedMethods: # 支持的方法\n              - GET\n              - POST\n              - PUT\n              - DELETE\n\n  main:\n    web-application-type: reactive',
        'd3d18f6a68483a368ad7d17211e2c32b', '2022-04-01 04:30:52', '2022-04-01 04:30:52', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (3, 18, 'waibao-gateway.yml', 'DEFAULT_GROUP', '',
        'spring:\n  cloud:\n    gateway:\n      discovery:\n        locator:\n          enabled: true\n      routes:\n        - id: waibao-user #payment_routh    #路由的ID，没有固定规则但要求唯一，简易配合服务名\n          #          uri: http://localhost:8001         #匹配后提供服务的路由地址\n          uri: lb://waibao-user   #匹配后提供服务的路由地址，lb后跟提供服务的微服务的名，不要写错\n          filters:\n          - VerifyAndAddUserId=\n          predicates:\n            - Path=/**          #断言，路径相匹配的进行路由\n      globalcors:\n        cors-configurations:\n          \'[/**]\': # 匹配所有请求\n            allowedOrigins: \"*\" #跨域处理 允许所有的域\n            allowedMethods: # 支持的方法\n              - GET\n              - POST\n              - PUT\n              - DELETE\n\n  main:\n    web-application-type: reactive',
        'f39bbb3a4f9488e7e63c2a7901bac8c3', '2022-04-01 04:44:44', '2022-04-01 04:44:45', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (3, 19, 'waibao-gateway.yml', 'DEFAULT_GROUP', '',
        'spring:\n  cloud:\n    gateway:\n      discovery:\n        locator:\n          enabled: true\n      routes:\n        - id: waibao-user #payment_routh    #路由的ID，没有固定规则但要求唯一，简易配合服务名\n          #          uri: http://localhost:8001         #匹配后提供服务的路由地址\n          uri: lb://waibao-user   #匹配后提供服务的路由地址，lb后跟提供服务的微服务的名，不要写错\n          filters:\n          - VerifyAndAddUserId=1,1\n          predicates:\n            - Path=/**          #断言，路径相匹配的进行路由\n      globalcors:\n        cors-configurations:\n          \'[/**]\': # 匹配所有请求\n            allowedOrigins: \"*\" #跨域处理 允许所有的域\n            allowedMethods: # 支持的方法\n              - GET\n              - POST\n              - PUT\n              - DELETE\n\n  main:\n    web-application-type: reactive',
        'cff51d0a77897813def403061f70652c', '2022-04-01 05:08:21', '2022-04-01 05:08:21', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (3, 20, 'waibao-gateway.yml', 'DEFAULT_GROUP', '',
        'spring:\n  cloud:\n    gateway:\n      discovery:\n        locator:\n          enabled: true\n      routes:\n        - id: waibao-user\n          uri: lb://waibao-user\n          filters:\n          - VerifyAndAddUserId=1,1\n          predicates:\n            - Path=/user/**\n\n        - id: waibao-admin\n          uri: lb://waibao-user\n          - VerifyAndAddAdminId=1,1\n          predicates:\n            - Path=/admin/**\n      globalcors:\n        cors-configurations:\n          \'[/**]\': # 匹配所有请求\n            allowedOrigins: \"*\" #跨域处理 允许所有的域\n            allowedMethods: # 支持的方法\n              - GET\n              - POST\n              - PUT\n              - DELETE\n\n  main:\n    web-application-type: reactive',
        'a7a3520d3e0d71d66b91d335ab1980ae', '2022-04-01 05:18:50', '2022-04-01 05:18:50', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (3, 21, 'waibao-gateway.yml', 'DEFAULT_GROUP', '',
        'spring:\n  cloud:\n    gateway:\n      discovery:\n        locator:\n          enabled: true\n      routes:\n        - id: waibao-user\n          uri: lb://waibao-user\n          filters:\n          - VerifyAndAddUserId=1,1\n          predicates:\n            - Path=/user/info,/user/check\n\n        - id: waibao-admin\n          uri: lb://waibao-user\n          - VerifyAndAddAdminId=1,1\n          predicates:\n            - Path=/admin/**\n      globalcors:\n        cors-configurations:\n          \'[/**]\': # 匹配所有请求\n            allowedOrigins: \"*\" #跨域处理 允许所有的域\n            allowedMethods: # 支持的方法\n              - GET\n              - POST\n              - PUT\n              - DELETE\n\n  main:\n    web-application-type: reactive',
        '09cb3d5b7d1bc81e8d7c13937e9d66fb', '2022-04-01 05:23:30', '2022-04-01 05:23:30', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (3, 22, 'waibao-gateway.yml', 'DEFAULT_GROUP', '',
        'spring:\n  cloud:\n    gateway:\n      discovery:\n        locator:\n          enabled: true\n      routes:\n        - id: waibao-user\n          uri: lb://waibao-user\n          filters:\n            - VerifyAndAddUserId=1,1\n          predicates:\n            - Path=/user/info,/user/check\n\n        - id: waibao-admin\n          uri: lb://waibao-user\n            - VerifyAndAddAdminId=1,1\n          predicates:\n            - Path=/admin/**\n      globalcors:\n        cors-configurations:\n          \'[/**]\': # 匹配所有请求\n            allowedOrigins: \"*\" #跨域处理 允许所有的域\n            allowedMethods: # 支持的方法\n              - GET\n              - POST\n              - PUT\n              - DELETE\n\n  main:\n    web-application-type: reactive',
        'e826d29ac7d99907e50e879a28a591a5', '2022-04-01 05:27:21', '2022-04-01 05:27:22', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (7, 23, 'waibao-seckill.yml', 'DEFAULT_GROUP', '',
        'spring:\n  shardingsphere:\n    datasource:\n      names: master,slave\n      master:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://10.61.20.211:33306/waibao_v2?useSSL=false&autoReconnect=true&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true\n        username: root\n        password: wssy001\n      slave:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://10.61.20.211:33307/waibao_v2?useSSL=false&autoReconnect=true&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true\n        username: root\n        password: wssy001\n\n    sharding:\n      tables:\n        user:\n          actualDataNodes: master.user_$->{0..1}\n          tableStrategy:\n            inline:\n              shardingColumn: id\n              algorithmExpression: user_$->{id % 2}\n          keyGenerator:\n            column: id\n            type: SNOWFLAKE\n\n      master-slave-rules:\n        master:\n          master-data-source-name: master\n          SlaveDataSourceNames: slave\n  task:\n    execution:\n      pool:\n        max-size: 20\n        keep-alive: 60s\n        core-size: 10\n        queue-capacity: 200\n      thread-name-prefix: 异步任务-\n    scheduling:\n      pool:\n        size: 5\n      thread-name-prefix: 定时任务-\nrocketmq:\n  name-server: 10.61.20.211:39876\n  producer:\n    group: order-producer\n\naj:\n  captcha:\n    cache-type: redis\n    interference-options: 2\n    type: blockpuzzle',
        '46812f71c772fc74eae1c38deed203e5', '2022-04-01 12:48:26', '2022-04-01 12:48:26', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (2, 24, 'waibao-user.yml', 'DEFAULT_GROUP', '',
        'spring:\n  shardingsphere:\n    datasource:\n      names: master,slave\n      master:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://10.61.20.211:33306/waibao_v2?useSSL=false&autoReconnect=true&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true\n        username: root\n        password: wssy001\n      slave:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://10.61.20.211:33307/waibao_v2?useSSL=false&autoReconnect=true&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true\n        username: root\n        password: wssy001\n\n    sharding:\n      tables:\n        userExtra:\n          actualDataNodes: master.user_extra\n        user:\n          actualDataNodes: master.user_$->{0..1}\n          tableStrategy:\n            inline:\n              shardingColumn: id\n              algorithmExpression: user_$->{id % 2}\n          keyGenerator:\n            column: id\n            type: SNOWFLAKE\n\n      master-slave-rules:\n        master:\n          master-data-source-name: master\n          SlaveDataSourceNames: slave',
        '2fdc2a7e492c216bf47c9404dba902d0', '2022-04-01 12:48:53', '2022-04-01 12:48:53', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (7, 25, 'waibao-seckill.yml', 'DEFAULT_GROUP', '',
        'spring:\n  shardingsphere:\n    datasource:\n      names: master,slave\n      master:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://10.61.20.211:33306/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: root\n        password: wssy001\n      slave:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://10.61.20.211:33307/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: root\n        password: wssy001\n\n      master-slave-rules:\n        master:\n          master-data-source-name: master\n          SlaveDataSourceNames: slave\n\n  task:\n    execution:\n      pool:\n        max-size: 20\n        keep-alive: 60s\n        core-size: 10\n        queue-capacity: 200\n      thread-name-prefix: 异步任务-\n    scheduling:\n      pool:\n        size: 5\n      thread-name-prefix: 定时任务-\n\n  cloud:\n    nacos:\n      server-addr: 10.61.20.211:38848\n      discovery:\n        namespace: waibao\n      username: nacos\n      password: nacos\n\n      config:\n        namespace: waibao\n        extension-configs: application.yml,${spring.application.name}.yml\n\nrocketmq:\n  name-server: 10.60.64.66:39876\n  producer:\n    group: order-producer\n\naj:\n  captcha:\n    cache-type: redis\n    interference-options: 2\n    type: blockpuzzle',
        '1cc8babcb11cb13de95ed4012735d42c', '2022-04-01 13:21:56', '2022-04-01 13:21:57', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (1, 26, 'application.yml', 'DEFAULT_GROUP', '',
        'spring:\n  redis:\n    host: 10.61.20.211\n    password: wssy001\n    timeout: 1000\n    lettuce:\n      pool:\n        min-idle: 5\n        max-idle: 10',
        '2589275754f828bfba32e6198494f7fb', '2022-04-02 04:51:16', '2022-04-02 04:51:17', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (1, 27, 'application.yml', 'DEFAULT_GROUP', '',
        'spring:\n  redis:\n    host: 10.61.20.211\n    password: wssy001\n    timeout: 1000\n    lettuce:\n      pool:\n        min-idle: 5\n        max-idle: 10\n\nwaibao:\n  db:\n    ip: 10.61.20.211\n    port: 33306\n    user-name: root\n    password: wssy001\n\n  redis:\n    ip: 10.61.20.211\n    port: 6379\n    password: wssy001\n\n  rocketmq:\n    ip: 10.61.20.211\n    port: 39876',
        '9d8f0200f5ae3b8ca86550b9f0ddecea', '2022-04-02 04:51:44', '2022-04-02 04:51:45', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (1, 28, 'application.yml', 'DEFAULT_GROUP', '',
        'spring:\n  redis:\n    host: 10.61.20.211\n    password: wssy001\n    timeout: 1000\n    lettuce:\n      pool:\n        min-idle: 5\n        max-idle: 10\n\nwaibao:\n  db:\n    ip: 10.61.20.211\n    port: 33306\n    user-name: root\n    password: wssy001\n\n  redis:\n    ip: 10.61.20.211\n    port: 6379\n    password: wssy001\n\n  rocketmq:\n    ip: 10.61.20.211\n    port: 39876',
        '9d8f0200f5ae3b8ca86550b9f0ddecea', '2022-04-02 04:52:53', '2022-04-02 04:52:53', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (2, 29, 'waibao-user.yml', 'DEFAULT_GROUP', '',
        'spring:\n  shardingsphere:\n    datasource:\n      names: master,slave\n      master:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://10.61.20.211:33306/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: root\n        password: wssy001\n      slave:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://10.61.20.211:33307/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: root\n        password: wssy001\n\n    sharding:\n      tables:\n        userExtra:\n          actualDataNodes: master.user_extra\n        user:\n          actualDataNodes: master.user_$->{0..1}\n          tableStrategy:\n            inline:\n              shardingColumn: id\n              algorithmExpression: user_$->{id % 2}\n          keyGenerator:\n            column: id\n            type: SNOWFLAKE\n\n      master-slave-rules:\n        master:\n          master-data-source-name: master\n          SlaveDataSourceNames: slave',
        '6458944d6806988bf31d48fa6b2f6ded', '2022-04-02 04:53:47', '2022-04-02 04:53:48', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (1, 30, 'application.yml', 'DEFAULT_GROUP', '',
        'spring:\n  redis:\n    host: 10.61.20.211\n    password: wssy001\n    timeout: 1000\n    lettuce:\n      pool:\n        min-idle: 5\n        max-idle: 10\n\nwaibao:\n  db:\n    ip: 10.61.20.211\n    port: 33306\n    username: root\n    password: wssy001\n\n  redis:\n    ip: 10.61.20.211\n    port: 6379\n    password: wssy001\n\n  rocketmq:\n    ip: 10.61.20.211\n    port: 39876',
        '4263c054054fe77dae5312c9632ca946', '2022-04-02 04:55:29', '2022-04-02 04:55:30', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (7, 31, 'waibao-seckill.yml', 'DEFAULT_GROUP', '',
        'spring:\n  shardingsphere:\n    datasource:\n      names: master,slave\n      master:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://10.61.20.211:33306/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: root\n        password: wssy001\n      slave:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://10.61.20.211:33307/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: root\n        password: wssy001\n\n      master-slave-rules:\n        master:\n          master-data-source-name: master\n          SlaveDataSourceNames: slave\n\n  task:\n    execution:\n      pool:\n        max-size: 20\n        keep-alive: 60s\n        core-size: 10\n        queue-capacity: 200\n      thread-name-prefix: 异步任务-\n    scheduling:\n      pool:\n        size: 5\n      thread-name-prefix: 定时任务-\n\n  cloud:\n    nacos:\n      server-addr: 10.61.20.211:38848\n      discovery:\n        namespace: waibao\n      username: nacos\n      password: nacos\n\n      config:\n        namespace: waibao\n        extension-configs: application.yml,${spring.application.name}.yml\n\nrocketmq:\n  name-server: 10.61.20.211:39876\n  producer:\n    group: order-producer\n\naj:\n  captcha:\n    cache-type: redis\n    interference-options: 2\n    type: blockpuzzle',
        'bb9d65c424e646d3796b008dbb5942ee', '2022-04-02 06:05:46', '2022-04-02 06:05:47', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (2, 32, 'waibao-user.yml', 'DEFAULT_GROUP', '',
        'spring:\n  shardingsphere:\n    datasource:\n      names: master,slave\n      master:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://${waibao.db.ip}:${waibao.db.port}/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: ${waibao.db.username}\n        password: ${waibao.db.password}\n      slave:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://${waibao.db.ip}:33307/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: ${waibao.db.username}\n        password: ${waibao.db.password}\n\n    sharding:\n      tables:\n        userExtra:\n          actualDataNodes: master.user_extra\n        user:\n          actualDataNodes: master.user_$->{0..1}\n          tableStrategy:\n            inline:\n              shardingColumn: id\n              algorithmExpression: user_$->{id % 2}\n          keyGenerator:\n            column: id\n            type: SNOWFLAKE\n\n      master-slave-rules:\n        master:\n          master-data-source-name: master\n          SlaveDataSourceNames: slave',
        '48141986907d57697bf3aae737d5e2fc', '2022-04-02 08:20:56', '2022-04-02 08:20:57', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (7, 33, 'waibao-seckill.yml', 'DEFAULT_GROUP', '',
        'spring:\n  shardingsphere:\n    datasource:\n      names: master,slave\n      master:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://${waibao.db.ip}:${waibao.db.port}/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: ${waibao.db.username}\n        password: ${waibao.db.password}\n      slave:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://${waibao.db.ip}:33307/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: ${waibao.db.username}\n        password: ${waibao.db.password}\n\n      master-slave-rules:\n        master:\n          master-data-source-name: master\n          SlaveDataSourceNames: slave\n\n  task:\n    execution:\n      pool:\n        max-size: 20\n        keep-alive: 60s\n        core-size: 10\n        queue-capacity: 200\n      thread-name-prefix: 异步任务-\n    scheduling:\n      pool:\n        size: 5\n      thread-name-prefix: 定时任务-\n\nrocketmq:\n  name-server: ${waibao.rocketmq.ip}:${waibao.rocketmq.port}\n\naj:\n  captcha:\n    cache-type: redis\n    interference-options: 2\n    type: blockpuzzle',
        'c92bba944b160b3b946f5c8e3978600b', '2022-04-02 08:22:17', '2022-04-02 08:22:17', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (7, 34, 'waibao-seckill.yml', 'DEFAULT_GROUP', '',
        'spring:\n  shardingsphere:\n    datasource:\n      names: master,slave\n      master:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://${waibao.db.ip}:${waibao.db.port}/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: ${waibao.db.username}\n        password: ${waibao.db.password}\n      slave:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://${waibao.db.ip}:33307/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: ${waibao.db.username}\n        password: ${waibao.db.password}\n\n  sharding:\n      tables:\n        goods:\n          actualDataNodes: master.goods\n        log_seckill_goods:\n          actualDataNodes: master.log_seckill_goods\n        mq_msg_compensation:\n          actualDataNodes: master.mq_msg_compensation\n        seckill_goods:\n          actualDataNodes: master.seckill_goods\n\n      master-slave-rules:\n        master:\n          master-data-source-name: master\n          SlaveDataSourceNames: slave\n\n  task:\n    execution:\n      pool:\n        max-size: 20\n        keep-alive: 60s\n        core-size: 10\n        queue-capacity: 200\n      thread-name-prefix: 异步任务-\n    scheduling:\n      pool:\n        size: 5\n      thread-name-prefix: 定时任务-\n\nrocketmq:\n  name-server: ${waibao.rocketmq.ip}:${waibao.rocketmq.port}\n\naj:\n  captcha:\n    cache-type: redis\n    interference-options: 2\n    type: blockpuzzle',
        'bce8a83913af52d140f5295123ba1b04', '2022-04-02 08:55:41', '2022-04-02 08:55:42', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (7, 35, 'waibao-seckill.yml', 'DEFAULT_GROUP', '',
        'spring:\n  shardingsphere:\n    datasource:\n      names: master,slave\n      master:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://${waibao.db.ip}:${waibao.db.port}/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: ${waibao.db.username}\n        password: ${waibao.db.password}\n      slave:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://${waibao.db.ip}:33307/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: ${waibao.db.username}\n        password: ${waibao.db.password}\n\n  # sharding:\n  #     tables:\n  #       goods:\n  #         actualDataNodes: master.goods\n  #       log_seckill_goods:\n  #         actualDataNodes: master.log_seckill_goods\n  #       mq_msg_compensation:\n  #         actualDataNodes: master.mq_msg_compensation\n  #       seckill_goods:\n  #         actualDataNodes: master.seckill_goods\n\n      master-slave-rules:\n        master:\n          master-data-source-name: master\n          SlaveDataSourceNames: slave\n\n  task:\n    execution:\n      pool:\n        max-size: 20\n        keep-alive: 60s\n        core-size: 10\n        queue-capacity: 200\n      thread-name-prefix: 异步任务-\n    scheduling:\n      pool:\n        size: 5\n      thread-name-prefix: 定时任务-\n\nrocketmq:\n  name-server: ${waibao.rocketmq.ip}:${waibao.rocketmq.port}\n\naj:\n  captcha:\n    cache-type: redis\n    interference-options: 2\n    type: blockpuzzle',
        'b473efe27b9de0e5dff95b7ac334ef9e', '2022-04-02 09:38:10', '2022-04-02 09:38:10', 'nacos', '172.17.0.1', 'U',
        'waibao');
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`,
                               `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`)
VALUES (7, 36, 'waibao-seckill.yml', 'DEFAULT_GROUP', '',
        'spring:\n  shardingsphere:\n    datasource:\n      names: master,slave\n      master:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://${waibao.db.ip}:${waibao.db.port}/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: ${waibao.db.username}\n        password: ${waibao.db.password}\n      slave:\n        type: com.zaxxer.hikari.HikariDataSource\n        driverClassName: com.mysql.cj.jdbc.Driver\n        jdbcUrl: jdbc:mysql://${waibao.db.ip}:33307/waibao_v2?useUnicode=true&useSSL=false&autoReconnect=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&rewriteBatchedStatements=true\n        username: ${waibao.db.username}\n        password: ${waibao.db.password}\n\n    sharding:\n      tables:\n        goods:\n          actualDataNodes: master.goods\n        log_seckill_goods:\n          actualDataNodes: master.log_seckill_goods\n        mq_msg_compensation:\n          actualDataNodes: master.mq_msg_compensation\n        seckill_goods:\n          actualDataNodes: master.seckill_goods\n\n      master-slave-rules:\n        master:\n          master-data-source-name: master\n          SlaveDataSourceNames: slave\n\n  task:\n    execution:\n      pool:\n        max-size: 20\n        keep-alive: 60s\n        core-size: 10\n        queue-capacity: 200\n      thread-name-prefix: 异步任务-\n    scheduling:\n      pool:\n        size: 5\n      thread-name-prefix: 定时任务-\n\nrocketmq:\n  name-server: ${waibao.rocketmq.ip}:${waibao.rocketmq.port}\n\naj:\n  captcha:\n    cache-type: redis\n    interference-options: 2\n    type: blockpuzzle',
        'd245231a62a64ae1871ae6d70b2f85d2', '2022-04-02 09:41:02', '2022-04-02 09:41:02', 'nacos', '172.17.0.1', 'U',
        'waibao');
COMMIT;
...
INSERT INTO `tenant_info` (`id`, `kp`, `tenant_id`, `tenant_name`, `tenant_desc`, `create_source`, `gmt_create`,
                           `gmt_modified`)
VALUES (2, '1', 'openresty', 'openresty', 'Openresty', 'nacos', 1648874802755, 1648874802755);
COMMIT;
